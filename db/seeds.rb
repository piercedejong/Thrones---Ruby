...
Faq.create(
  [
    ...
    {fid:8, question:"How do House character predictions get decided?", answer: "Each House will have a character prediction sheet based on the avarage consensus of the House members. E.g. If the House has 6 members and 3 say that Jon Snow will live, 2 say that he will die, and 1 says he will vecome a wight, the House prediciton will be that Jon Snow is alive at the end of the season. If there is a tie between two predicitons (alive/dead, alive/wight, dead/wight), then the character is predicted to be alive, if alive is one of the splits and is considered to be dead if the split is between dead/wight."},
    {fid:9, question:"How do House questions get answered?", answer:"Every House will get the same questions between each episode. Each House member has the opportunity to answer the questions and the answer with the highest votes will be the Houses answer."},
    ...
    {fid:12,question:"Contact Information",answer:"If you have any other questions or need clarification, contact Pierce at wwdeathpool@gmail.com. Please use the email you signed up when contacting Pierce and fully read the rules and faqs before contacting."},
  ]
)
