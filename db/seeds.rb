...
Faq.create(
  [
    ...
    {fid:4, question:"Why can't I see other peoples predictions?",answer:"You will be able to see other peoples predicitons after the entry time has close on April 14th. Until then tyou will be able to only the average prediction for each character in the statistics tab"}.
    ...
    {fid:8, question:"",answer:"If you have any other questions or need clarification, contact Pierce at wwdeathpool@gmail.com. Please use the email you signed up when contacting Pierce."},
  ]
)
