...
Faq.create(
  [
    ...
    {fid:9, question:"",answer:"If you have any other questions or need clarification, contact Pierce at wwdeathpool@gmail.com. Please use the email you signed up when contacting Pierce and fully read the rules and faqs before contacting Pierce"},
  ]
)
