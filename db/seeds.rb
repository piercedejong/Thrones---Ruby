...
Faq.create(
  [
    ...
    {fid:3,question:"How do character that have been revived work in this pool?", answer:"All characters that have been resurrected on the show are considered to be alive at the start of the season. E.g. Jon Snow, The Mountain, Beric Dondarrion."},
