...
Rule.create(
    [
      ...
      {rid: 2,rule: "If you think the character will die, you can predict if they become a wight or not. If the character becomes a wight, you gain ONE extra point on top of the point gained for predicting their death. If you predict the charater will only die and they become a wight, you still get ONE point for correctly predicting their death."},
...
Faq.create(
  [
    ...
    {fid:3, question:"How long do I have to make my predictions?", answer:"You have until 1 hour before season 8 premieres, 6:00pm MT / 8:00pm EST, April 14th. (The countdown on the main page)"},
    ...
    {fid:8, question:"Can I change my House?", answer:"Yes, you can. The deadline is 2 hours before the premier starts (April 14th, 5:00pm MT / 7:00pm EST)"},
