...
Faq.create(
  [
    ...
    {fid:4, question:"Why can't I see other peoples predictions?",answer:"You will only be able to see other peoples predicitons after the entry time has close on April 14th. Until then you will be able to only see the average prediction for each character in the statistics tab"},
