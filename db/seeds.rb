...
Rule.create(
    [
      ...
      {rid: 6,rule: "Each player is a member of a House. Each House the opertunity to win 20% of the total pot split between all memebers equally. House points are awarded by character predictions and House questioins asked between each episode."},
    ]
)
...
Faq.create(
  [
    ...
    {fid:3, question:"How long do I have to make my predictions?", answer:"You have until 1 hour before season 8 premieres (6:00pm MT / 7:00pm CT, April 14th). At this point your preicitons will be submitted and you will not be allowed ot change them."},
    {fid:4, question:"Why can't I see my House and other players predictions?",answer:"You will only be able to see House and other players predicitons after the entry time has close on April 14th. Until then you will be able to only see the average prediction for each character in the statistics tab."},
    {fid:5, question:"How do character that have been resurrected work in the pool?", answer:"All characters that have been resurrected on the show are considered to be alive at the start of the season. E.g. Jon Snow, The Mountain, Beric Dondarrion."},
    {fid:6, question:"How do the Night King and Viserion work in the pool?", answer:"The Night King and Viserion are both considered alive at the start of season 8 and can only be predicted to be alive or dead at the end of the season. They cannot be predicted to become a wight."},
    {fid:7, question:"Can I change my House?", answer:"Yes you can, you have until 1 hour until season 8 premieres ti change your House."},
    {fid:8, question:"How do House character predictions get decided?", answer: "Each House will have a character prediction sheet based on the avarage cosensuss of the House members. E.g. If the House has 6 members and 3 say that Jon Snow will live, 2 say that he will die, and 1 says he will vecome a wight, the House prediciton will be that Jon Snow is alive at the end of the season. If there is a tie between two predicitons (alive/dead, alive/wight, dead/wight), then the character is predicted to be alive, if alive is one of the splits and is condisdered to be dead if the split is between dead/wight."},
    {fid:9, question:"How do House questions get answered?", answer:"Every House will get the same questions between each episode. Each House member has the opertunity to answer the questions and the answer with the hieghest votes will be the Houses answer."},
    {fid:10, question:"What happend if there is a tie for first, second or third palce?", answer:"If two players tie for first place, the money from second place will be added to the first place pool and will split between the two players on first place. The third palce pool will then be given to the player in second place. I.e. the two players in first place will split 70% of the pot and the player in second will get the third place pot. If there is a three way or more tie for first place, the entire pool is split between the victors. If there is a tie for sceond place, the third place prize is added to the second place prize and us split between all who are in second place. If there is a third place tie, the thrid place pool is simply spliy between all of the players in third place."},
    {fid:11, question:"What determines if a character is alive, dead or a  at the end of the season?", answer: "If a character is not seen killed on screen or explicitly stated as dead by another character (Stannis Baratheon), they are considered to be alive. If the character is seen to be killed on screen or said to have died off screen by another character, they are considered to to be dead. If a character has died and then risen as a wight, they are considered to be a wight for the remainder of the season no matter what happens to the character. (If a character is slain as a wight they are still considered to be a wight and not as dead)."},
    {fid:12, question:"Contatct Information",answer:"If you have any other questions or need clarification, contact Pierce at wwdeathpool@gmail.com. Please use the email you signed up when contacting Pierce and fully read the rules and faqs before contacting."},
  ]
)
